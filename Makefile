# ====================================================================================
# Setup Project
PROJECT_NAME := ec2offering-crossplane-provider
PROJECT_REPO := github.com/Oded-B/$(PROJECT_NAME)
...
XPKGS = provider-ec2offering
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-ec2offering: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Ec2Offering CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Ec2Offering controllers
...
# This target prepares repo for your provider by replacing all "ec2offering"
