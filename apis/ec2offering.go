...
// Package apis contains Kubernetes API for the Ec2Offering provider.
package apis

import (
	"k8s.io/apimachinery/pkg/runtime"

	samplev1alpha1 "github.com/Oded-B/ec2offering-crossplane-provider/apis/sample/v1alpha1"
